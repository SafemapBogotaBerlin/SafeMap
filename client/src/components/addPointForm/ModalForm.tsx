...
const ModalForm = () => {
  ...
  const times = ['Now', '15 minures ago', '30 minutes ago', '1 hour ago', '3 hours ago', 'earlier']
  
  const timesToTimestamp = (timeString) => {
    switch (timeString) {
      case 'Now': return Date.now();
      case '15 minures ago' : return Date.now() - 15*60*1000;
      case '30 minutes ago' : return Date.now() - 30*60*1000;
      case '1 hour ago' : return Date.now() - 60*60*1000;
      case '3 hours ago' : return Date.now() - 180*60*1000;
      default: return Date.now() - 240*60*1000;
    }
  }
  /* const hideForm = () => {
