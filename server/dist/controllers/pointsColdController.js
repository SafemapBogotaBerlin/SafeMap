...
function addPoint(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            const id = yield (0, pointsCold_1.addColdPointModel)({ user_id, added_dttm, danger_type, coordinates });
            if (id) {
...
function getColdPoints(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            console.log('here');
            const documents = yield (0, pointsCold_1.getColdPointsModel)();
            if (documents) {
...
//# sourceMappingURL=pointsColdController.js.map