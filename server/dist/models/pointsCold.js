...
function addColdPointModel(data) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const docRef = yield (0, firestore_1.addDoc)((0, firestore_1.collection)(db_1.default, dangerPointsCollection), data);
            return docRef.id;
        }
        catch (error) {
...
//# sourceMappingURL=pointsCold.js.map